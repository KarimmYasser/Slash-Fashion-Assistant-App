...
class ChooseFacialhairColor extends StatefulWidget {
  const ChooseFacialhairColor({super.key, required this.onSelection});
  final void Function() onSelection;
  @override
  State<ChooseFacialhairColor> createState() => _ChooseFacialhairColorState();
}

class _ChooseFacialhairColorState extends State<ChooseFacialhairColor>
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: QuestionPubble(
                        message: 'what is your facial hair color?'),
                  ),
                )
              ],
            ),
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                ...
                if (isMale) {
                  avatarsMap['male']!['facialHairColor'] = 3;
                } else {
                  avatarsMap['female']!['facialHairColor'] = 3;
                }
              });
              widget.onSelection();
            },
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                ...
                if (isMale) {
                  avatarsMap['male']!['facialHairColor'] = 1;
                } else {
                  avatarsMap['female']!['facialHairColor'] = 1;
                }
              });
              widget.onSelection();
            },
          ...
          GestureDetector(
            onTap: () {
              setState(() {
                ...
                if (isMale) {
                  avatarsMap['male']!['facialHairColor'] = 4;
                } else {
                  avatarsMap['female']!['facialHairColor'] = 4;
                }
              });
              widget.onSelection();
            },
